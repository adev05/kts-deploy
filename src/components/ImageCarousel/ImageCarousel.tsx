...
const ImageCarousel: React.FC<ImageCarouselProps> = ({ images, className }) => {
  ...
  return (
    <div className={cn(s.carousel, className)}>
      ...
      {images.length > 1 && (
        <>
          <Button className={cn(s.carousel__button, s.carousel__button_prev)} onClick={handlePrev} variant="secondary">
            ←
          </Button>
          <Button className={cn(s.carousel__button, s.carousel__button_next)} onClick={handleNext} variant="secondary">
            →
          </Button>
